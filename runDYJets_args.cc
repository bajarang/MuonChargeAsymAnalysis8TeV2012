...
using namespace std;
*/
//void runDYJets_args(string passedLineNum, string passeddoQCD, string passedSystematics, string passedDirection){
void runDYJets_args(){

  //cout << "Passed Arguments : " << passedLineNum << "  " << passeddoQCD << "  " << passedSystematics << "  " << passedDirection << endl;
  ...
  strLineNum     << passedLineNum;
  strLineNum     >> intLineNum;
  strDOQCD       << passeddoQCD;
  strLineNum     >> intDOQCD;
  strSystematics << passedSystematics;
  strSystematics >> intSystematics;
  strDirection   << passedDirection;
  ...
  if(intDOQCD>3) {
    cout << "You entered doQCD = " << intDOQCD << endl;
  ...
  if(!matchesSysteamtics) {
    cout << "You entered systematics = " << intSystematics << endl;
  ...
  */
  ////////////////Compile related codes and load libraries/////////////////
  ...
  int doDirection  = 0;
                           // 0 - central, 1 - Up direction, -1 - Down Direction
                           // 100 - all directions (-1 and 1)
