...
ZJetsAndDPS::ZJetsAndDPS(string fileName_, float lumiScale_, float puScale_, bool useTriggerCorrection_, bool useEfficiencyCorrection_, 
    ...
    HistoSet(fileName_.substr(0, fileName_.find("_"))), nEvents_10000(nEvents_10000_), outputDirectory("../../Results/HistoFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjet/"),
