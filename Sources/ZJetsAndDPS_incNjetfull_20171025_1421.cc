...
//        //---------
        ...
        if (hasGenInfo){
            if (passesGenLeptonCut && passesDPSPartonCut && passesGenJetCut){
                ...
                if(genLep1.Pt() > 45) genlepEta_Zinc0jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
                ...
                if (nGoodGenJets >= 1){
                    ...
                    if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) genlepEta_Zinc1jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) genlepEta_Zinc1jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) genlepEta_Zinc1jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) genlepEta_Zinc1jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 45) genlepEta_Zinc1jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
                    if (doZ || doTT){
                ...
                if (nGoodGenJets >= 2){
                    ...
                    if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) genlepEta_Zinc2jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) genlepEta_Zinc2jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) genlepEta_Zinc2jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) genlepEta_Zinc2jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 45) genlepEta_Zinc2jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
                    if (doZ || doTT){
                ...
                if (nGoodGenJets >= 3){
                    ...
                    if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) genlepEta_Zinc3jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) genlepEta_Zinc3jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) genlepEta_Zinc3jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) genlepEta_Zinc3jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 45) genlepEta_Zinc3jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
                ...
                if (nGoodGenJets >= 4){
                    ...
                    if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) genlepEta_Zinc4jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) genlepEta_Zinc4jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) genlepEta_Zinc4jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) genlepEta_Zinc4jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
                    if(genLep1.Pt() > 45) genlepEta_Zinc4jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
        ...
        if (hasRecoInfo && passesLeptonCut && passesJetCut && passesDPSPartonCut) {
            ...
            if(lepton1.pt > 45)   lepEta_Zinc0jet_leppt_45_above->Fill(lepton1.eta, weight);
            ...
            if (nGoodJets == 0){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zexc0jet_leppt_25_30->Fill(lepton1.eta, weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zexc0jet_leppt_30_35->Fill(lepton1.eta, weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zexc0jet_leppt_35_40->Fill(lepton1.eta, weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zexc0jet_leppt_40_45->Fill(lepton1.eta, weight);
                if(lepton1.pt > 45)   lepEta_Zexc0jet_leppt_45_above->Fill(lepton1.eta, weight);
            ...
            if (nGoodJets >= 1){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zinc1jet_leppt_25_30->Fill(lepton1.eta, weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zinc1jet_leppt_30_35->Fill(lepton1.eta, weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zinc1jet_leppt_35_40->Fill(lepton1.eta, weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zinc1jet_leppt_40_45->Fill(lepton1.eta, weight);
                if(lepton1.pt > 45)   lepEta_Zinc1jet_leppt_45_above->Fill(lepton1.eta, weight);
                ...
                if (nGoodJets == 1){
                    ...
                    if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zexc1jet_leppt_25_30->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zexc1jet_leppt_30_35->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zexc1jet_leppt_35_40->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zexc1jet_leppt_40_45->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 45)   lepEta_Zexc1jet_leppt_45_above->Fill(lepton1.eta, weight);
            ...
            if (nGoodJets >= 2){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zinc2jet_leppt_25_30->Fill(lepton1.eta, weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zinc2jet_leppt_30_35->Fill(lepton1.eta, weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zinc2jet_leppt_35_40->Fill(lepton1.eta, weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zinc2jet_leppt_40_45->Fill(lepton1.eta, weight);
                if(lepton1.pt > 45)   lepEta_Zinc2jet_leppt_45_above->Fill(lepton1.eta, weight);
                ...
                if (nGoodJets == 2){
                    ...
                    if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zexc2jet_leppt_25_30->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zexc2jet_leppt_30_35->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zexc2jet_leppt_35_40->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zexc2jet_leppt_40_45->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 45)   lepEta_Zexc2jet_leppt_45_above->Fill(lepton1.eta, weight);
            ...
            if (nGoodJets >= 3) {
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zinc3jet_leppt_25_30->Fill(lepton1.eta, weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zinc3jet_leppt_30_35->Fill(lepton1.eta, weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zinc3jet_leppt_35_40->Fill(lepton1.eta, weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zinc3jet_leppt_40_45->Fill(lepton1.eta, weight);
                if(lepton1.pt > 45)   lepEta_Zinc3jet_leppt_45_above->Fill(lepton1.eta, weight);
                ...
                if (nGoodJets == 3){
                    ...
                    if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zexc3jet_leppt_25_30->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zexc3jet_leppt_30_35->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zexc3jet_leppt_35_40->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zexc3jet_leppt_40_45->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 45)   lepEta_Zexc3jet_leppt_45_above->Fill(lepton1.eta, weight);
            ...
            if (nGoodJets >= 4){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zinc4jet_leppt_25_30->Fill(lepton1.eta, weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zinc4jet_leppt_30_35->Fill(lepton1.eta, weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zinc4jet_leppt_35_40->Fill(lepton1.eta, weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zinc4jet_leppt_40_45->Fill(lepton1.eta, weight);
                if(lepton1.pt > 45)   lepEta_Zinc4jet_leppt_45_above->Fill(lepton1.eta, weight);
                ...
                if (nGoodJets == 4){
                    ...
                    if(lepton1.pt > 25 && lepton1.pt <= 30)   lepEta_Zexc4jet_leppt_25_30->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 30 && lepton1.pt <= 35)   lepEta_Zexc4jet_leppt_30_35->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 35 && lepton1.pt <= 40)   lepEta_Zexc4jet_leppt_35_40->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 40 && lepton1.pt <= 45)   lepEta_Zexc4jet_leppt_40_45->Fill(lepton1.eta, weight);
                    if(lepton1.pt > 45)   lepEta_Zexc4jet_leppt_45_above->Fill(lepton1.eta, weight);
...
ZJetsAndDPS::ZJetsAndDPS(string fileName_, float lumiScale_, float puScale_, bool useTriggerCorrection_, bool useEfficiencyCorrection_, 
    ...
    HistoSet(fileName_.substr(0, fileName_.find("_"))), nEvents_10000(nEvents_10000_), outputDirectory("../../Results/HistoFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/"),
