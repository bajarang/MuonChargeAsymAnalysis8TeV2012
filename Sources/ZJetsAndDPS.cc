        ...
        int doBJets, int doPUStudy, bool doFlat, bool useRoch, bool doVarWidth,  bool hasPartonInfo, string pdfSet, int pdfMember)
{
    ...
    for(int i=0; i<38; i++){
      ...
      if(textline.find("GenMuon1PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon1PtMin=columnval;
      }
      if(textline.find("GenMuon1PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon1PtMax=columnval;
      }
      if(textline.find("GenMuon1EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon1EtaMin=columnval;
      }
      if(textline.find("GenMuon1EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon1EtaMax=columnval;
      }
      if(textline.find("GenMuon2PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon2PtMin=columnval;
      }
      if(textline.find("GenMuon2PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon2PtMax=columnval;
      }
      if(textline.find("GenMuon2EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon2EtaMin=columnval;
      }
      if(textline.find("GenMuon2EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenMuon2EtaMax=columnval;
      }
      if(textline.find("RecMuon1PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon1PtMin=columnval;
      }
      if(textline.find("RecMuon1PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon1PtMax=columnval;
      }
      if(textline.find("RecMuon1EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon1EtaMin=columnval;
      }
      if(textline.find("RecMuon1EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon1EtaMax=columnval;
      }
      if(textline.find("RecMuon1Iso")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon1Iso=columnval;
      }
      if(textline.find("RecMuon2PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon2PtMin=columnval;
      }
      if(textline.find("RecMuon2PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon2PtMax=columnval;
      }
      if(textline.find("RecMuon2EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon2EtaMin=columnval;
      }
      if(textline.find("RecMuon2EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon2EtaMax=columnval;
      }
      if(textline.find("RecMuon2Iso")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecMuon2Iso=columnval;
      }
      if(textline.find("GenJetPtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenJetPtMin=columnval;
      }
      if(textline.find("GenJetPtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenJetPtMax=columnval;
      }
      if(textline.find("GenJetEtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenJetEtaMin=columnval;
      }
      if(textline.find("GenJetEtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenJetEtaMax=columnval;
      }
      if(textline.find("RecJetPtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecJetPtMin=columnval;
      }
      if(textline.find("RecJetPtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecJetPtMax=columnval;
      }
      if(textline.find("RecJetEtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecJetEtaMin=columnval;
      }
      if(textline.find("RecJetEtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecJetEtaMax=columnval;
      }
      if(textline.find("GenV_MassMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_MassMin=columnval;
      }
      if(textline.find("GenV_MassMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_MassMax=columnval;
      }
      if(textline.find("GenV_PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_PtMin=columnval;
      }
      if(textline.find("GenV_PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_PtMax=columnval;
      }
      if(textline.find("GenV_EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_EtaMin=columnval;
      }
      if(textline.find("GenV_EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        GenV_EtaMax=columnval;
      }
      if(textline.find("RecV_MassMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_MassMin=columnval;
      }
      if(textline.find("RecV_MassMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_MassMax=columnval;
      }
      if(textline.find("RecV_PtMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_PtMin=columnval;
      }
      if(textline.find("RecV_PtMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_PtMax=columnval;
      }
      if(textline.find("RecV_EtaMin")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_EtaMin=columnval;
      }
      if(textline.find("RecV_EtaMax")!=string::npos){
        sscanf(linest, "%*s %f", &columnval);
        RecV_EtaMax=columnval;
      }
    }
    infile.close(); 
    ...
    double cutNum0TotalWeight(0.),cutNum1TrigPtEtaTotalWeight(0.),cutNum2IdTotalWeight(0.); 
    double cutNum3DxyTotalWeight(0.),cutNum4IsoTotalWeight(0.),cutNum5MetmTTotalWeight(0.); 
    double cutNum6BJetsTotalWeight(0.),cutNum7TotalWeight(0.);
    ...
    if (systematics == 12 && direction ==  1) lumiScale = lumiScale*(1+0.026);
    if (systematics == 12 && direction == -1) lumiScale = lumiScale*(1-0.026);
    ...
    //for (Long64_t jentry(0); jentry < 200; jentry++)        
        ...
        bool cutNum4Iso = false, cutNum5MetmT = false, cutNum6BJets = false;
        //=======================================================================================================//
        ...
        if (hasRecoInfo) {
            ...
            if (doMuons){
                ...
                for (unsigned short i(0); i < nTotLeptons; i++) {
                    cutNum1TrigPtEta = false; cutNum2Id = false; 
                    cutNum3Dxy = false;       cutNum4Iso = false;
                    nextBin = 0;
                    //ADDED FOR CUTFLOW (BEGIN)
                    if (useEfficiencyCorrection) {
                        double effWeight = 1.;
                        if (leptonFlavor == "SingleMuon") {
                            effWeight = LeptID.getEfficiency(patMuonPt_->at(i), patMuonEta_->at(i), sysLepSF);
                            if (useTriggerCorrection) {
                                effWeight *= LeptTrig.getEfficiency(patMuonPt_->at(i), patMuonEta_->at(i), sysLepSF);
                            }
                        }
                        else if (leptonFlavor == "SingleElectron") {
                            effWeight *= LeptID.getEfficiency(patMuonPt_->at(i), patMuonEta_->at(i), sysLepSF);
                            effWeight *= Ele_Rec.getEfficiency(patMuonPt_->at(i), patMuonEta_->at(i), sysLepSF);
                        }
                        //effWeight = 1;
                        if (isData) weight /= effWeight;
                        else weight *= effWeight;
                    }
                    //ADDED FOR CUTFLOW (END)
                    //ALL THE WEIGHTS ARE CALCULATED ABOVE
                    ...
                    cutFlow->Fill(nextBin, weight);
                    cutNum0TotalWeight = cutNum0TotalWeight + weight;
                    //cout << "Num0 : "<< cutNum0TotalWeight << "\t" << weight << endl;
                    ...
                    if(eventTrigger && muPassesPtCut && muPassesEtaCut){
                         
                        nextBin = nextBin + 1;
                        cutFlow->Fill(nextBin, weight);
                        cutNum1TrigPtEta = true;
                        cutNum1TrigPtEtaTotalWeight = cutNum1TrigPtEtaTotalWeight + weight;
                        //cout << "Num1 : " << cutNum1TrigPtEtaTotalWeight << "\t" << weight << endl;
                    }                  
                    ...
                    if(muPassesIdCut && cutNum1TrigPtEta){
                        nextBin = nextBin + 1;
                        cutFlow->Fill(nextBin, weight);
			cutNum2Id = true;
                        cutNum2IdTotalWeight = cutNum2IdTotalWeight + weight;
                        //cout << "Num2 : " << cutNum2IdTotalWeight << "\t" << weight << endl;
                    }                  

                    //bool muPassesIdCut(int(patMuonCombId_->at(i)) >= 1 ); // this is for Loose ID

                    bool muPassesDxyCut(patMuonDxy_->at(i) < 0.2);
                    if(!muPassesDxyCut) cout << jentry << endl;
                    if(muPassesDxyCut && cutNum2Id){
                        nextBin = nextBin + 1;
                        cutFlow->Fill(nextBin, weight);
                        cutNum3Dxy = true;
                        cutNum3DxyTotalWeight = cutNum3DxyTotalWeight + weight;
                        //cout << "Num3 : " << cutNum3DxyTotalWeight << "\t" << weight << endl;
                    }             
     
                    bool muPassesIsoCut((!doW && patMuonPfIsoDbeta_->at(i) < 0.2) || (doW && patMuonPfIsoDbeta_->at(i) < RecMuon1Iso));  
                    if(muPassesIsoCut && cutNum3Dxy){
                        nextBin = nextBin + 1;
                        cutFlow->Fill(nextBin, weight);
                        cutNum4Iso = true;
                        cutNum4IsoTotalWeight = cutNum4IsoTotalWeight + weight;
                        //cout << "Num4 : " << cutNum4IsoTotalWeight << "\t" << weight << endl;
                    }             
            ...
            if (doW && ((leptonFlavor == "SingleMuon" && nMuons == 1 && nLeptons == 1 && nElectrons == 0) || (leptonFlavor == "SingleElectron" && nMuons == 0 && nLeptons == 1 && nElectrons == 1))) {
                ...
                */ 
                ...
                if ((passesWhichWCut) && (METpt >= METcut && (((doQCD % 2) == 0 && MT >= RecV_MassMin) || ((doQCD % 2) == 1 && MT < RecV_MassMin)))) {
                    ...
                    cutFlow->Fill(nextBin, weight);
                    cutNum5MetmT = true;
                    cutNum5MetmTTotalWeight = cutNum5MetmTTotalWeight + weight;
                }
            }
        } // END IF RECO FOR MET
...
//        //---------
        ...
        if (hasGenInfo){
            if (passesGenLeptonCut && passesDPSPartonCut && passesGenJetCut){
                ...
                if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
                    genlepEta_Zinc0jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
                    genMET_Zinc0jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
                    genMT_Zinc0jet_leppt_25_30->Fill(genMT, genWeight);
                }
                if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
                    genlepEta_Zinc0jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
                    genMET_Zinc0jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
                    genMT_Zinc0jet_leppt_30_35->Fill(genMT, genWeight);
                }
                if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
                    genlepEta_Zinc0jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
                    genMET_Zinc0jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
                    genMT_Zinc0jet_leppt_35_40->Fill(genMT, genWeight);
                }
                if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
                    genlepEta_Zinc0jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
                    genMET_Zinc0jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
                    genMT_Zinc0jet_leppt_40_45->Fill(genMT, genWeight);
                }
                if(genLep1.Pt() > 45) {
                    genlepEta_Zinc0jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
                    genMET_Zinc0jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
                    genMT_Zinc0jet_leppt_45_above->Fill(genMT, genWeight);
                }
                ...
                if(nGoodGenJets == 0){
					genlepEta_Zexc0jet->Fill(genLep1.Eta(), genWeight);
					genMET_Zexc0jet->Fill(genLepton2.pt, genWeight);
					genMT_Zexc0jet->Fill(genMT, genWeight);
					if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
						genlepEta_Zexc0jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc0jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
						genMT_Zexc0jet_leppt_25_30->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
						genlepEta_Zexc0jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc0jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
						genMT_Zexc0jet_leppt_30_35->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
						genlepEta_Zexc0jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc0jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
						genMT_Zexc0jet_leppt_35_40->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
						genlepEta_Zexc0jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc0jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
						genMT_Zexc0jet_leppt_40_45->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 45) {
						genlepEta_Zexc0jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc0jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
						genMT_Zexc0jet_leppt_45_above->Fill(genMT, genWeight);
					}
                }
                ...
                if (nGoodGenJets >= 1){
					...
					genMET_Zinc1jet->Fill(genLepton2.pt, genWeight);
					genMT_Zinc1jet->Fill(genMT, genWeight);
					if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
						genlepEta_Zinc1jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc1jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
						genMT_Zinc1jet_leppt_25_30->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
						genlepEta_Zinc1jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc1jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
						genMT_Zinc1jet_leppt_30_35->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
						genlepEta_Zinc1jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc1jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
						genMT_Zinc1jet_leppt_35_40->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
						genlepEta_Zinc1jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc1jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
						genMT_Zinc1jet_leppt_40_45->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 45) {
						genlepEta_Zinc1jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc1jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
						genMT_Zinc1jet_leppt_45_above->Fill(genMT, genWeight);
					}
                    //-------
					...
					if(nGoodGenJets == 1){
						genlepEta_Zexc1jet->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc1jet->Fill(genLepton2.pt, genWeight);
						genMT_Zexc1jet->Fill(genMT, genWeight);
						if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
							genlepEta_Zexc1jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc1jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
							genMT_Zexc1jet_leppt_25_30->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
							genlepEta_Zexc1jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc1jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
							genMT_Zexc1jet_leppt_30_35->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
							genlepEta_Zexc1jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc1jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
							genMT_Zexc1jet_leppt_35_40->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
							genlepEta_Zexc1jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc1jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
							genMT_Zexc1jet_leppt_40_45->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 45) {
							genlepEta_Zexc1jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc1jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
							genMT_Zexc1jet_leppt_45_above->Fill(genMT, genWeight);
						}
					}
                ...
                if (nGoodGenJets >= 2){
					...
					genMET_Zinc2jet->Fill(genLepton2.pt, genWeight);
					genMT_Zinc2jet->Fill(genMT, genWeight);
					if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
						genlepEta_Zinc2jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc2jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
						genMT_Zinc2jet_leppt_25_30->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
						genlepEta_Zinc2jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc2jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
						genMT_Zinc2jet_leppt_30_35->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
						genlepEta_Zinc2jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc2jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
						genMT_Zinc2jet_leppt_35_40->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
						genlepEta_Zinc2jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc2jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
						genMT_Zinc2jet_leppt_40_45->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 45) {
						genlepEta_Zinc2jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc2jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
						genMT_Zinc2jet_leppt_45_above->Fill(genMT, genWeight);
					}
                    ...
                    if (nGoodGenJets == 2){
						...
						genlepEta_Zexc2jet->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc2jet->Fill(genLepton2.pt, genWeight);
						genMT_Zexc2jet->Fill(genMT, genWeight);
						if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
							genlepEta_Zexc2jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc2jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
							genMT_Zexc2jet_leppt_25_30->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
							genlepEta_Zexc2jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc2jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
							genMT_Zexc2jet_leppt_30_35->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
							genlepEta_Zexc2jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc2jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
							genMT_Zexc2jet_leppt_35_40->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
							genlepEta_Zexc2jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc2jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
							genMT_Zexc2jet_leppt_40_45->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 45) {
							genlepEta_Zexc2jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc2jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
							genMT_Zexc2jet_leppt_45_above->Fill(genMT, genWeight);
						}
                ...
                if (nGoodGenJets >= 3){
					...
					genlepEta_Zinc3jet->Fill(genLep1.Eta(), genWeight);
					genMET_Zinc3jet->Fill(genLepton2.pt, genWeight);
					genMT_Zinc3jet->Fill(genMT, genWeight);
					if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
						genlepEta_Zinc3jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc3jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
						genMT_Zinc3jet_leppt_25_30->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
						genlepEta_Zinc3jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc3jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
						genMT_Zinc3jet_leppt_30_35->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
						genlepEta_Zinc3jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc3jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
						genMT_Zinc3jet_leppt_35_40->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
						genlepEta_Zinc3jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc3jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
						genMT_Zinc3jet_leppt_40_45->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 45) {
						genlepEta_Zinc3jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc3jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
						genMT_Zinc3jet_leppt_45_above->Fill(genMT, genWeight);
					}

					if(nGoodGenJets == 3){
						genlepEta_Zexc3jet->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc3jet->Fill(genLepton2.pt, genWeight);
						genMT_Zexc3jet->Fill(genMT, genWeight);
						if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
							genlepEta_Zexc3jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc3jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
							genMT_Zexc3jet_leppt_25_30->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
							genlepEta_Zexc3jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc3jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
							genMT_Zexc3jet_leppt_30_35->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
							genlepEta_Zexc3jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc3jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
							genMT_Zexc3jet_leppt_35_40->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
							genlepEta_Zexc3jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc3jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
							genMT_Zexc3jet_leppt_40_45->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 45) {
							genlepEta_Zexc3jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc3jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
							genMT_Zexc3jet_leppt_45_above->Fill(genMT, genWeight);
						}
					}
                }
                if (nGoodGenJets >= 4){
					...
					genlepEta_Zinc4jet->Fill(genLep1.Eta(), genWeight);
					genMET_Zinc4jet->Fill(genLepton2.pt, genWeight);
					genMT_Zinc4jet->Fill(genMT, genWeight);
					if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
						genlepEta_Zinc4jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc4jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
						genMT_Zinc4jet_leppt_25_30->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
						genlepEta_Zinc4jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc4jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
						genMT_Zinc4jet_leppt_30_35->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
						genlepEta_Zinc4jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc4jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
						genMT_Zinc4jet_leppt_35_40->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
						genlepEta_Zinc4jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc4jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
						genMT_Zinc4jet_leppt_40_45->Fill(genMT, genWeight);
					}
					if(genLep1.Pt() > 45) {
						genlepEta_Zinc4jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
						genMET_Zinc4jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
						genMT_Zinc4jet_leppt_45_above->Fill(genMT, genWeight);
					}
					if(nGoodGenJets == 4){
						genlepEta_Zexc4jet->Fill(genLep1.Eta(), genWeight);
						genMET_Zexc4jet->Fill(genLepton2.pt, genWeight);
						genMT_Zexc4jet->Fill(genMT, genWeight);
						if(genLep1.Pt() > 25 && genLep1.Pt() <= 30) {
							genlepEta_Zexc4jet_leppt_25_30->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc4jet_leppt_25_30->Fill(genLepton2.pt, genWeight);
							genMT_Zexc4jet_leppt_25_30->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 30 && genLep1.Pt() <= 35) {
							genlepEta_Zexc4jet_leppt_30_35->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc4jet_leppt_30_35->Fill(genLepton2.pt, genWeight);
							genMT_Zexc4jet_leppt_30_35->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 35 && genLep1.Pt() <= 40) {
							genlepEta_Zexc4jet_leppt_35_40->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc4jet_leppt_35_40->Fill(genLepton2.pt, genWeight);
							genMT_Zexc4jet_leppt_35_40->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 40 && genLep1.Pt() <= 45) {
							genlepEta_Zexc4jet_leppt_40_45->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc4jet_leppt_40_45->Fill(genLepton2.pt, genWeight);
							genMT_Zexc4jet_leppt_40_45->Fill(genMT, genWeight);
						}
						if(genLep1.Pt() > 45) {
							genlepEta_Zexc4jet_leppt_45_above->Fill(genLep1.Eta(), genWeight);
							genMET_Zexc4jet_leppt_45_above->Fill(genLepton2.pt, genWeight);
							genMT_Zexc4jet_leppt_45_above->Fill(genMT, genWeight);
						}
					}
        ...
        //====================================//
        //cout << "\t\t\t\t\t" << passesLeptonCut << "\t" << passesJetCut << "\t" << passesDPSPartonCut << endl;
        if (hasRecoInfo && passesLeptonCut && passesJetCut && passesDPSPartonCut) {
            ...
            //cout << "Tot : "<< "\t" << TotalRecoWeightPassRECO << "\t" << weight << endl;
            ...
            if(cutNum5MetmT){
              ...
              cutFlow->Fill(nextBin, weight);
              cutNum6BJets = true;
              cutNum6BJetsTotalWeight = cutNum6BJetsTotalWeight + weight;
              //cout << "Num6 : " << cutNum6BJetsTotalWeight << "\t" << weight << endl;
            }
            ...
            if(lepton1.pt > 25 && lepton1.pt <= 30)   {
                lepEta_Zinc0jet_leppt_25_30->Fill(lepton1.eta, weight);
				MET_Zinc0jet_leppt_25_30->Fill(METpt, weight);
				MT_Zinc0jet_leppt_25_30->Fill(MT, weight);
            }
            if(lepton1.pt > 30 && lepton1.pt <= 35)   {
                lepEta_Zinc0jet_leppt_30_35->Fill(lepton1.eta, weight);
				MET_Zinc0jet_leppt_30_35->Fill(METpt, weight);
				MT_Zinc0jet_leppt_30_35->Fill(MT, weight);
            }
            if(lepton1.pt > 35 && lepton1.pt <= 40)   {
                lepEta_Zinc0jet_leppt_35_40->Fill(lepton1.eta, weight);
				MET_Zinc0jet_leppt_35_40->Fill(METpt, weight);
				MT_Zinc0jet_leppt_35_40->Fill(MT, weight);
            }
            if(lepton1.pt > 40 && lepton1.pt <= 45)   {
                lepEta_Zinc0jet_leppt_40_45->Fill(lepton1.eta, weight);
				MET_Zinc0jet_leppt_40_45->Fill(METpt, weight);
				MT_Zinc0jet_leppt_40_45->Fill(MT, weight);
            }
            if(lepton1.pt > 45)   {
                lepEta_Zinc0jet_leppt_45_above->Fill(lepton1.eta, weight);
				MET_Zinc0jet_leppt_45_above->Fill(METpt, weight);
				MT_Zinc0jet_leppt_45_above->Fill(MT, weight);
            }
            //---
            ...
            if (nGoodJets == 0){
				...
				MET_Zexc0jet->Fill(METpt, weight);
				MT_Zexc0jet->Fill(MT, weight);
				if(lepton1.pt > 25 && lepton1.pt <= 30)   {
					lepEta_Zexc0jet_leppt_25_30->Fill(lepton1.eta, weight);
					MET_Zexc0jet_leppt_25_30->Fill(METpt, weight);
					MT_Zexc0jet_leppt_25_30->Fill(MT, weight);
				}
				if(lepton1.pt > 30 && lepton1.pt <= 35)   {
					lepEta_Zexc0jet_leppt_30_35->Fill(lepton1.eta, weight);
					MET_Zexc0jet_leppt_30_35->Fill(METpt, weight);
					MT_Zexc0jet_leppt_30_35->Fill(MT, weight);
				}
				if(lepton1.pt > 35 && lepton1.pt <= 40)   {
					lepEta_Zexc0jet_leppt_35_40->Fill(lepton1.eta, weight);
					MET_Zexc0jet_leppt_35_40->Fill(METpt, weight);
					MT_Zexc0jet_leppt_35_40->Fill(MT, weight);
				}
				if(lepton1.pt > 40 && lepton1.pt <= 45)   {
					lepEta_Zexc0jet_leppt_40_45->Fill(lepton1.eta, weight);
					MET_Zexc0jet_leppt_40_45->Fill(METpt, weight);
					MT_Zexc0jet_leppt_40_45->Fill(MT, weight);
				}
				if(lepton1.pt > 45)   {
					lepEta_Zexc0jet_leppt_45_above->Fill(lepton1.eta, weight);
					MET_Zexc0jet_leppt_45_above->Fill(METpt, weight);
					MT_Zexc0jet_leppt_45_above->Fill(MT, weight);
				}
				//---
            ...
            if (nGoodJets >= 1){
				...
				if(lepton1.pt > 25 && lepton1.pt <= 30)   {
					lepEta_Zinc1jet_leppt_25_30->Fill(lepton1.eta, weight);
					MET_Zinc1jet_leppt_25_30->Fill(METpt, weight);
					MT_Zinc1jet_leppt_25_30->Fill(MT, weight);
				}
				if(lepton1.pt > 30 && lepton1.pt <= 35)   {
					lepEta_Zinc1jet_leppt_30_35->Fill(lepton1.eta, weight);
					MET_Zinc1jet_leppt_30_35->Fill(METpt, weight);
					MT_Zinc1jet_leppt_30_35->Fill(MT, weight);
				}
				if(lepton1.pt > 35 && lepton1.pt <= 40)   {
					lepEta_Zinc1jet_leppt_35_40->Fill(lepton1.eta, weight);
					MET_Zinc1jet_leppt_35_40->Fill(METpt, weight);
					MT_Zinc1jet_leppt_35_40->Fill(MT, weight);
				}
				if(lepton1.pt > 40 && lepton1.pt <= 45)   {
					lepEta_Zinc1jet_leppt_40_45->Fill(lepton1.eta, weight);
					MET_Zinc1jet_leppt_40_45->Fill(METpt, weight);
					MT_Zinc1jet_leppt_40_45->Fill(MT, weight);
				}
				if(lepton1.pt > 45)   {
					lepEta_Zinc1jet_leppt_45_above->Fill(lepton1.eta, weight);
					MET_Zinc1jet_leppt_45_above->Fill(METpt, weight);
					MT_Zinc1jet_leppt_45_above->Fill(MT, weight);
				}
				//---
                ...
                if (nGoodJets == 1){
					...
					MET_Zexc1jet->Fill(METpt, weight);
					MT_Zexc1jet->Fill(MT, weight);
					if(lepton1.pt > 25 && lepton1.pt <= 30)   {
						lepEta_Zexc1jet_leppt_25_30->Fill(lepton1.eta, weight);
						MET_Zexc1jet_leppt_25_30->Fill(METpt, weight);
						MT_Zexc1jet_leppt_25_30->Fill(MT, weight);
					}
					if(lepton1.pt > 30 && lepton1.pt <= 35)   {
						lepEta_Zexc1jet_leppt_30_35->Fill(lepton1.eta, weight);
						MET_Zexc1jet_leppt_30_35->Fill(METpt, weight);
						MT_Zexc1jet_leppt_30_35->Fill(MT, weight);
					}
					if(lepton1.pt > 35 && lepton1.pt <= 40)   {
						lepEta_Zexc1jet_leppt_35_40->Fill(lepton1.eta, weight);
						MET_Zexc1jet_leppt_35_40->Fill(METpt, weight);
						MT_Zexc1jet_leppt_35_40->Fill(MT, weight);
					}
					if(lepton1.pt > 40 && lepton1.pt <= 45)   {
						lepEta_Zexc1jet_leppt_40_45->Fill(lepton1.eta, weight);
						MET_Zexc1jet_leppt_40_45->Fill(METpt, weight);
						MT_Zexc1jet_leppt_40_45->Fill(MT, weight);
					}
					if(lepton1.pt > 45)   {
						lepEta_Zexc1jet_leppt_45_above->Fill(lepton1.eta, weight);
						MET_Zexc1jet_leppt_45_above->Fill(METpt, weight);
						MT_Zexc1jet_leppt_45_above->Fill(MT, weight);
					}
					//---
            ...
            if (nGoodJets >= 2){
				...
				if(lepton1.pt > 25 && lepton1.pt <= 30)   {
					lepEta_Zinc2jet_leppt_25_30->Fill(lepton1.eta, weight);
					MET_Zinc2jet_leppt_25_30->Fill(METpt, weight);
					MT_Zinc2jet_leppt_25_30->Fill(MT, weight);
				}
				if(lepton1.pt > 30 && lepton1.pt <= 35)   {
					lepEta_Zinc2jet_leppt_30_35->Fill(lepton1.eta, weight);
					MET_Zinc2jet_leppt_30_35->Fill(METpt, weight);
					MT_Zinc2jet_leppt_30_35->Fill(MT, weight);
				}
				if(lepton1.pt > 35 && lepton1.pt <= 40)   {
					lepEta_Zinc2jet_leppt_35_40->Fill(lepton1.eta, weight);
					MET_Zinc2jet_leppt_35_40->Fill(METpt, weight);
					MT_Zinc2jet_leppt_35_40->Fill(MT, weight);
				}
				if(lepton1.pt > 40 && lepton1.pt <= 45)   {
					lepEta_Zinc2jet_leppt_40_45->Fill(lepton1.eta, weight);
					MET_Zinc2jet_leppt_40_45->Fill(METpt, weight);
					MT_Zinc2jet_leppt_40_45->Fill(MT, weight);
				}
				if(lepton1.pt > 45)   {
					lepEta_Zinc2jet_leppt_45_above->Fill(lepton1.eta, weight);
					MET_Zinc2jet_leppt_45_above->Fill(METpt, weight);
					MT_Zinc2jet_leppt_45_above->Fill(MT, weight);
				}
				//---
                ...
                if (nGoodJets == 2){
					...
					MET_Zexc2jet->Fill(METpt, weight);
					MT_Zexc2jet->Fill(MT, weight);
					if(lepton1.pt > 25 && lepton1.pt <= 30)   {
						lepEta_Zexc2jet_leppt_25_30->Fill(lepton1.eta, weight);
						MET_Zexc2jet_leppt_25_30->Fill(METpt, weight);
						MT_Zexc2jet_leppt_25_30->Fill(MT, weight);
					}
					if(lepton1.pt > 30 && lepton1.pt <= 35)   {
						lepEta_Zexc2jet_leppt_30_35->Fill(lepton1.eta, weight);
						MET_Zexc2jet_leppt_30_35->Fill(METpt, weight);
						MT_Zexc2jet_leppt_30_35->Fill(MT, weight);
					}
					if(lepton1.pt > 35 && lepton1.pt <= 40)   {
						lepEta_Zexc2jet_leppt_35_40->Fill(lepton1.eta, weight);
						MET_Zexc2jet_leppt_35_40->Fill(METpt, weight);
						MT_Zexc2jet_leppt_35_40->Fill(MT, weight);
					}
					if(lepton1.pt > 40 && lepton1.pt <= 45)   {
						lepEta_Zexc2jet_leppt_40_45->Fill(lepton1.eta, weight);
						MET_Zexc2jet_leppt_40_45->Fill(METpt, weight);
						MT_Zexc2jet_leppt_40_45->Fill(MT, weight);
					}
					if(lepton1.pt > 45)   {
						lepEta_Zexc2jet_leppt_45_above->Fill(lepton1.eta, weight);
						MET_Zexc2jet_leppt_45_above->Fill(METpt, weight);
						MT_Zexc2jet_leppt_45_above->Fill(MT, weight);
					}
					//---
            ...
            if (nGoodJets >= 3) {
				...
				if(lepton1.pt > 25 && lepton1.pt <= 30)   {
					lepEta_Zinc3jet_leppt_25_30->Fill(lepton1.eta, weight);
					MET_Zinc3jet_leppt_25_30->Fill(METpt, weight);
					MT_Zinc3jet_leppt_25_30->Fill(MT, weight);
				}
				if(lepton1.pt > 30 && lepton1.pt <= 35)   {
					lepEta_Zinc3jet_leppt_30_35->Fill(lepton1.eta, weight);
					MET_Zinc3jet_leppt_30_35->Fill(METpt, weight);
					MT_Zinc3jet_leppt_30_35->Fill(MT, weight);
				}
				if(lepton1.pt > 35 && lepton1.pt <= 40)   {
					lepEta_Zinc3jet_leppt_35_40->Fill(lepton1.eta, weight);
					MET_Zinc3jet_leppt_35_40->Fill(METpt, weight);
					MT_Zinc3jet_leppt_35_40->Fill(MT, weight);
				}
				if(lepton1.pt > 40 && lepton1.pt <= 45)   {
					lepEta_Zinc3jet_leppt_40_45->Fill(lepton1.eta, weight);
					MET_Zinc3jet_leppt_40_45->Fill(METpt, weight);
					MT_Zinc3jet_leppt_40_45->Fill(MT, weight);
				}
				if(lepton1.pt > 45)   {
					lepEta_Zinc3jet_leppt_45_above->Fill(lepton1.eta, weight);
					MET_Zinc3jet_leppt_45_above->Fill(METpt, weight);
					MT_Zinc3jet_leppt_45_above->Fill(MT, weight);
				}
				//---
                ...
                if (nGoodJets == 3){
					...
					MET_Zexc3jet->Fill(METpt, weight);
					MT_Zexc3jet->Fill(MT, weight);
					if(lepton1.pt > 25 && lepton1.pt <= 30)   {
						lepEta_Zexc3jet_leppt_25_30->Fill(lepton1.eta, weight);
						MET_Zexc3jet_leppt_25_30->Fill(METpt, weight);
						MT_Zexc3jet_leppt_25_30->Fill(MT, weight);
					}
					if(lepton1.pt > 30 && lepton1.pt <= 35)   {
						lepEta_Zexc3jet_leppt_30_35->Fill(lepton1.eta, weight);
						MET_Zexc3jet_leppt_30_35->Fill(METpt, weight);
						MT_Zexc3jet_leppt_30_35->Fill(MT, weight);
					}
					if(lepton1.pt > 35 && lepton1.pt <= 40)   {
						lepEta_Zexc3jet_leppt_35_40->Fill(lepton1.eta, weight);
						MET_Zexc3jet_leppt_35_40->Fill(METpt, weight);
						MT_Zexc3jet_leppt_35_40->Fill(MT, weight);
					}
					if(lepton1.pt > 40 && lepton1.pt <= 45)   {
						lepEta_Zexc3jet_leppt_40_45->Fill(lepton1.eta, weight);
						MET_Zexc3jet_leppt_40_45->Fill(METpt, weight);
						MT_Zexc3jet_leppt_40_45->Fill(MT, weight);
					}
					if(lepton1.pt > 45)   {
						lepEta_Zexc3jet_leppt_45_above->Fill(lepton1.eta, weight);
						MET_Zexc3jet_leppt_45_above->Fill(METpt, weight);
						MT_Zexc3jet_leppt_45_above->Fill(MT, weight);
					}
					//---
            ...
            if (nGoodJets >= 4){
				...
				MET_Zinc4jet->Fill(METpt, weight);
				MT_Zinc4jet->Fill(MT, weight);
				if(lepton1.pt > 25 && lepton1.pt <= 30)   {
					lepEta_Zinc4jet_leppt_25_30->Fill(lepton1.eta, weight);
					MET_Zinc4jet_leppt_25_30->Fill(METpt, weight);
					MT_Zinc4jet_leppt_25_30->Fill(MT, weight);
				}
				if(lepton1.pt > 30 && lepton1.pt <= 35)   {
					lepEta_Zinc4jet_leppt_30_35->Fill(lepton1.eta, weight);
					MET_Zinc4jet_leppt_30_35->Fill(METpt, weight);
					MT_Zinc4jet_leppt_30_35->Fill(MT, weight);
				}
				if(lepton1.pt > 35 && lepton1.pt <= 40)   {
					lepEta_Zinc4jet_leppt_35_40->Fill(lepton1.eta, weight);
					MET_Zinc4jet_leppt_35_40->Fill(METpt, weight);
					MT_Zinc4jet_leppt_35_40->Fill(MT, weight);
				}
				if(lepton1.pt > 40 && lepton1.pt <= 45)   {
					lepEta_Zinc4jet_leppt_40_45->Fill(lepton1.eta, weight);
					MET_Zinc4jet_leppt_40_45->Fill(METpt, weight);
					MT_Zinc4jet_leppt_40_45->Fill(MT, weight);
				}
				if(lepton1.pt > 45)   {
					lepEta_Zinc4jet_leppt_45_above->Fill(lepton1.eta, weight);
					MET_Zinc4jet_leppt_45_above->Fill(METpt, weight);
					MT_Zinc4jet_leppt_45_above->Fill(MT, weight);
				}
				//---
                ...
                if (nGoodJets == 4){
					...
					MET_Zexc4jet->Fill(METpt, weight);
					MT_Zexc4jet->Fill(MT, weight);
					if(lepton1.pt > 25 && lepton1.pt <= 30)   {
						lepEta_Zexc4jet_leppt_25_30->Fill(lepton1.eta, weight);
						MET_Zexc4jet_leppt_25_30->Fill(METpt, weight);
						MT_Zexc4jet_leppt_25_30->Fill(MT, weight);
					}
					if(lepton1.pt > 30 && lepton1.pt <= 35)   {
						lepEta_Zexc4jet_leppt_30_35->Fill(lepton1.eta, weight);
						MET_Zexc4jet_leppt_30_35->Fill(METpt, weight);
						MT_Zexc4jet_leppt_30_35->Fill(MT, weight);
					}
					if(lepton1.pt > 35 && lepton1.pt <= 40)   {
						lepEta_Zexc4jet_leppt_35_40->Fill(lepton1.eta, weight);
						MET_Zexc4jet_leppt_35_40->Fill(METpt, weight);
						MT_Zexc4jet_leppt_35_40->Fill(MT, weight);
					}
					if(lepton1.pt > 40 && lepton1.pt <= 45)   {
						lepEta_Zexc4jet_leppt_40_45->Fill(lepton1.eta, weight);
						MET_Zexc4jet_leppt_40_45->Fill(METpt, weight);
						MT_Zexc4jet_leppt_40_45->Fill(MT, weight);
					}
					if(lepton1.pt > 45)   {
						lepEta_Zexc4jet_leppt_45_above->Fill(lepton1.eta, weight);
						MET_Zexc4jet_leppt_45_above->Fill(METpt, weight);
						MT_Zexc4jet_leppt_45_above->Fill(MT, weight);
					}
					//---
        ...
        if (DEBUG) cout << "Stop after line " << __LINE__ << endl;
            ...
            if(lepton1.pt > 45) hresponselepEta_Zinc0jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets == 0 && nGoodJets == 0){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zexc0jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zexc0jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zexc0jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zexc0jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45)                       hresponselepEta_Zexc0jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets >= 1 && nGoodJets >= 1){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zinc1jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zinc1jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zinc1jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zinc1jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45) hresponselepEta_Zinc1jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets == 1 && nGoodJets == 1){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zexc1jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zexc1jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zexc1jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zexc1jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45)                       hresponselepEta_Zexc1jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets >= 2 && nGoodJets >= 2){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zinc2jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zinc2jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zinc2jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zinc2jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45) hresponselepEta_Zinc2jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets == 2 && nGoodJets == 2){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zexc2jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zexc2jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zexc2jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zexc2jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45)                       hresponselepEta_Zexc2jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets >= 3 && nGoodJets >= 3){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zinc3jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zinc3jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zinc3jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zinc3jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45) hresponselepEta_Zinc3jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets == 3 && nGoodJets == 3){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zexc3jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zexc3jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zexc3jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zexc3jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45)                       hresponselepEta_Zexc3jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets >= 4 && nGoodJets >= 4){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zinc4jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zinc4jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zinc4jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zinc4jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45) hresponselepEta_Zinc4jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
            ...
            if (nGoodGenJets == 4 && nGoodJets == 4){
                ...
                if(lepton1.pt > 25 && lepton1.pt <= 30)   hresponselepEta_Zexc4jet_leppt_25_30->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 30 && lepton1.pt <= 35)   hresponselepEta_Zexc4jet_leppt_30_35->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 35 && lepton1.pt <= 40)   hresponselepEta_Zexc4jet_leppt_35_40->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 40 && lepton1.pt <= 45)   hresponselepEta_Zexc4jet_leppt_40_45->Fill(lep1.Eta(), genLep1.Eta(), weight);
                if(lepton1.pt > 45)                       hresponselepEta_Zexc4jet_leppt_45_above->Fill(lep1.Eta(), genLep1.Eta(), weight);
    ...
    cout << "............  CutFlow ..........................." << endl;
    cout << "Without any cut                                : " << cutNum0TotalWeight << endl;
    cout << "After cutNum1TrigPtEta (trigger+pt+eta)        : " << cutNum1TrigPtEtaTotalWeight << endl;
    cout << "After cutNum2Id (Id)                           : " << cutNum2IdTotalWeight << endl;
    cout << "After cutNum3Dxy (Dxy)                         : " << cutNum3DxyTotalWeight << endl;
    cout << "After cutNum4Iso (Iso)                         : " << cutNum4IsoTotalWeight << endl;
    cout << "After cutNum5MetmT (MET+mT)                    : " << cutNum5MetmTTotalWeight << endl;
    cout << "After cutNum6BJets (BVeto)                     : " << cutNum6BJetsTotalWeight << endl;
}
...
ZJetsAndDPS::ZJetsAndDPS(string fileName_, int WCharge_, float lumiScale_, float puScale_, bool useTriggerCorrection_, bool useEfficiencyCorrection_,  int systematics_, int direction_, float xsecfactor_, int RecJetPtMin_, int RecJetPtMax_, int ZPtCutMin_, int ZEtaCutMin_, int ZEtaCutMax_, int METcut_, int MTcut_, bool nEvents_10000_, int RecJetEtaMin_, int RecJetEtaMax_): 
    HistoSet(fileName_.substr(0, fileName_.find("_"))), nEvents_10000(nEvents_10000_), outputDirectory("/home/bsutar/t3store2/MuonChargeAsymAnalysis8TeV2012/Results/HistoFiles/Condor/102/"),
...
string ZJetsAndDPS::CreateOutputFileName(bool useRoch, bool doFlat, int doPUStudy, bool doVarWidth, int doBJets, int doQCD, bool doSSign, bool doInvMassCut, string pdfSet, int pdfMember)
{
    ...
    if      (direction ==  0) result << "_CN";
    else if (direction ==  1) result << "_UP";
    else if (direction == -1) result << "_DN";
