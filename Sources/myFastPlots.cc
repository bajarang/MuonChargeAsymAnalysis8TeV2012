...
void myFastPlots(string leptonFlavor, strWCharge, strVariable, strRange, strClosureTest, strSystematics, strDirection);
{
  TH1::SetDefaultSumw2();
  TH2::SetDefaultSumw2();
  gStyle->SetOptStat(0);
  ...
  if (variable == ""){
    ...
    if(varList->Contains(variable.c_str())){
      TObjString *name = new TObjString(variable.c_str());
      ...
      if (!isMuon) FastPlotsRun(sel, nsel, leptonFlavor, variable.c_str(),1,1,5,5,closureTest);
      if (isMuon)  FastPlotsRun(sel, nsel, leptonFlavor, variable.c_str(),1,1,5,5,closureTest);
    }
  }
}
...
{
  cout << __LINE__ << "\tCLOSURETEST : \t|\t" << closureTest << endl;
  ...
  //leppt
  if(variable.find("leppt_25_30")      != string::npos) appendstring = "_leppt_25_30";
  if(variable.find("leppt_30_35")      != string::npos) appendstring = "_leppt_30_35";
  if(variable.find("leppt_35_40")      != string::npos) appendstring = "_leppt_35_40";
  if(variable.find("leppt_40_45")      != string::npos) appendstring = "_leppt_40_45";
  if(variable.find("leppt_45_above")      != string::npos) appendstring = "_leppt_45_above";
  outputDirectory = "../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/FastPlots_" + jetPtMin.str() + "_Syst_" + systematicsmc + appendstring;
...
int UnfoldData(const TString lepSel, const TString algo, int svdKterm, RooUnfoldResponse *resp, TH1D *hRecDataMinusFakes, TH1D* &hUnfData, string variable, TString name)
{
  ...
  string command = "EMPTY"; // = "delete/";
  if(systematicsmc == "0" && systematicsdata == "0"){
    command = "mkdir -p ../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring;
  }
  if(systematicsmc == "0" && systematicsdata != "0"){
    command = "mkdir -p ../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsdata + appendstring;
  }
  if(systematicsmc != "0" && systematicsdata == "0"){
    command = "mkdir -p ../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring;
  }
  ...
  if(systematicsmc == "0" && systematicsdata == "0"){
    f = new TFile("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + ".root", "RECREATE");
  }
  if(systematicsmc == "0" && systematicsdata != "0"){
    f = new TFile("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsdata + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + ".root", "RECREATE");
  }
  if(systematicsmc != "0" && systematicsdata == "0"){
    f = new TFile("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + ".root", "RECREATE");
  }
  ...
  chchi2->Write();
  if(systematicsmc == "0" && systematicsdata == "0"){
    chchi2->Print("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + "_chi2.pdf");
  }
  if(systematicsmc == "0" && systematicsdata != "0"){
    chchi2->Print("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsdata + appendstring + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + "_chi2.pdf");
  }
  if(systematicsmc != "0" && systematicsdata == "0"){
    chchi2->Print("../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/incNjetfull/UnfoldingCheck_" + systematicsmc + appendstring + "/" + lepSel + "_" + variable + "_" + name + "_" + algo + "_chi2.pdf");
  }
