...
void Plotter(string leptonFlavor = "Muons", int JetPtMin = 30,
        int doQCD = 0, bool doSSign = 0, bool doInvMassCut = 0, int MET = 15, int doBJets = -1 , 
        ...
        bool doRoch = 0, bool doFlat = 0, bool doVarWidth = 1)
{
    ...
    string outputFileName = "../../Results/PNGFiles/MySetOfCuts/MuPt25/wplus/FinerBins/Systematics/CENTRAL/ComparisonDataWithMC/Comparison_" + leptonFlavor + "_" + energy + "_Data_All_MC_";
    ...
    for (unsigned short i(0); i < nHistNoGen; i++) {
        ...
        ////hist[0][i]->GetYaxis()->SetTitle("MC / Data");//20170530_0924
        hist[0][i]->GetYaxis()->SetTitle("Data / MC");
